	...
	if (vflag_atom) {
	  for (int ii = 0; ii < nall; ++ii){
	    ...
	    //vatom[ii][5] += 1.0 * dvatom[9*ii+7];
            ...
            //vatom[ii][1] += 1.0 * dvatom[9*ii+4]; // yy 
            //vatom[ii][2] += 1.0 * dvatom[9*ii+8]; // zz
            //vatom[ii][3] += 1.0 * dvatom[9*ii+1]; // xy +3]; // xy
            //vatom[ii][4] += 1.0 * dvatom[9*ii+2]; // xz 6]; // xz
            //vatom[ii][5] += 1.0 * dvatom[9*ii+5]; // yz 7]; // yz
            //vatom[ii][6] += 1.0 * dvatom[9*ii+3]; // yx 1]; // yx
            //vatom[ii][7] += 1.0 * dvatom[9*ii+6]; // zx 2]; // zx
            //vatom[ii][8] += 1.0 * dvatom[9*ii+7]; // zy 5]; // zy
	  }
	  if (newton_pair) {
