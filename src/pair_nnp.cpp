	...
	if (vflag_atom) {
	  for (int ii = 0; ii < nall; ++ii){
	    ...
	    //vatom[ii][5] += 1.0 * dvatom[9*ii+7];
            cvatom[ii][0] += -2.0 * dvatom[9*ii+0]; // xx
            cvatom[ii][1] += -2.0 * dvatom[9*ii+4]; // yy 
            cvatom[ii][2] += -2.0 * dvatom[9*ii+8]; // zz
            cvatom[ii][3] += -2.0 * dvatom[9*ii+3]; // xy
            cvatom[ii][4] += -2.0 * dvatom[9*ii+6]; // xz
